...
<html>
    ...
    <body>
        ...
        <main>
           <div class="log-in-box">
                <p style="font-weight: bold;">Inicia sesión como administrador</p>
    ...
    <script>
        function login(){
                ...
                form_data.append("type", 'login');                   // Creating object of FormData class
                form_data.append("ema", user);              // Appending parameter named file with properties of file_field to form_data
                form_data.append("pass", pass);                 // Adding extra parameters to form_data
